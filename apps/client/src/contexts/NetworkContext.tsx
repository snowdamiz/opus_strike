...
export function NetworkProvider({ children }: { children: ReactNode }) {
  ...
  }, [rejectPendingVoiceTokenRequests, rejectPendingPlayerReportRequests, setMatchStartGateKey, enterObserverMode]);
