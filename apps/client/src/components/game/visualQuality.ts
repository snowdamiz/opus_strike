...
export const BATTLE_ROYAL_VISIBILITY_CONFIG: Record<GraphicsPreset, BattleRoyalVisibilityConfig> = {
  potato: {
    ...
    terrainPrebuildFullDistance: 58,
  ...
  competitive: {
    ...
    terrainLodFullDistance: 58,
    terrainLodCoarseDistance: 128,
    terrainPrebuildFullDistance: 68,
  ...
  cinematic: {
    ...
    terrainLodFullDistance: 90,
    terrainLodCoarseDistance: 202,
    terrainPrebuildFullDistance: 108,
