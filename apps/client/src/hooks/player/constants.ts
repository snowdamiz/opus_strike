...
export const BLAZE_BOMB_COOLDOWN = BLAZE_BOMB_COOLDOWN_MS;
export const BLAZE_BOMB_FALL_DURATION = 1500;
export const BLAZE_BOMB_WARNING_LEAD = 350;
...
// Hookshot
export const HOOKSHOT_FIRE_INTERVAL = HOOKSHOT_CHAIN_HOOKS_COOLDOWN_MS;
export const HOOKSHOT_SPEED = 38;
export const HOOKSHOT_MAX_DISTANCE = HOOKSHOT_CHAIN_HOOKS_MAX_DISTANCE;
export const DRAG_HOOK_COOLDOWN = HOOKSHOT_DRAG_HOOK_COOLDOWN_MS;
export const DRAG_HOOK_SPEED = 50;
export const DRAG_HOOK_RETRACT_SPEED = HOOKSHOT_DRAG_HOOK_RETRACT_SPEED;
