...
const DEFAULT_TREASURY_RESERVE_LAMPORTS = 0n;
const DEFAULT_PAYOUT_BATCH_SIZE = 100;
const DEFAULT_RANKED_BR_COMBAT_REWARDS_ENABLED = true;
const DEFAULT_RANKED_BR_COMBAT_REWARDS_SHADOW_MODE = false;
...
const DEFAULT_RANKED_BR_TREASURY_EXPOSURE_BPS = 10_000;
