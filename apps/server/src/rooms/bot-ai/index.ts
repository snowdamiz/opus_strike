...
export const BOT_RANKED_BATTLE_ROYAL_SKILL_PROFILE: BotSkillProfile = {
  ...
  reactionMs: 460,
  turnRateRadians: 5.2,
  aimLeadSeconds: 0.055,
  aimErrorRadians: 0.16,
  aimJitterRefreshMs: [460, 900],
  aimFireToleranceScale: 0.97,
  fireChance: 0.5,
  secondaryChance: 0.28,
  fireDecisionMs: [390, 760],
  burstDurationMs: [180, 440],
  abilityCadenceMs: [2150, 4100],
  ultimateCadenceMs: [3250, 5900],
  preferredRangeScale: 0.96,
  aggression: 0.7,
  retreatHealthRatio: 0.41,
  routeDangerWeight: 0.72,
  blockedEdgeTtlMs: 1800,
  pathExpansionLimit: 32,
  memoryMs: 1650,
  minHealValue: 76,
  abilityScoreThreshold: 86,
  replanIntervalMs: 720,
  localProbeDistance: 1.45,
  focusFireWeight: 0.62,
  escortCommitDistance: 28,
  directRouteBias: 0.74,
};
