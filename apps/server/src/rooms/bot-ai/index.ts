...
export const BOT_SKILL_PROFILES: Record<BotDifficulty, BotSkillProfile> = {
  easy: {
    ...
    aimJitterRefreshMs: [760, 1500],
    aimFireToleranceScale: 1,
    fireChance: 0.22,
    secondaryChance: 0.08,
    fireDecisionMs: [680, 1260],
    burstDurationMs: [100, 250],
    abilityCadenceMs: [3200, 5400],
    ultimateCadenceMs: [4800, 8200],
    preferredRangeScale: 0.94,
    aggression: 0.42,
    retreatHealthRatio: 0.62,
    routeDangerWeight: 0.24,
    blockedEdgeTtlMs: 700,
    pathExpansionLimit: 10,
    memoryMs: 350,
    minHealValue: 54,
    abilityScoreThreshold: 58,
    replanIntervalMs: 1100,
    localProbeDistance: 0.9,
    focusFireWeight: 0.14,
    escortCommitDistance: 12,
    directRouteBias: 0.62,
  },
  normal: {
    thinkIntervalMs: 520,
    reactionMs: 650,
    ...
    aimJitterRefreshMs: [620, 1200],
    aimFireToleranceScale: 1,
    fireChance: 0.34,
    secondaryChance: 0.18,
    fireDecisionMs: [520, 980],
    burstDurationMs: [140, 360],
    abilityCadenceMs: [2600, 4600],
    ultimateCadenceMs: [3600, 6600],
    preferredRangeScale: 1,
    aggression: 0.58,
    retreatHealthRatio: 0.44,
    routeDangerWeight: 0.5,
    blockedEdgeTtlMs: 1300,
    pathExpansionLimit: 22,
    memoryMs: 850,
    minHealValue: 86,
    abilityScoreThreshold: 88,
    replanIntervalMs: 820,
    localProbeDistance: 1.25,
    focusFireWeight: 0.38,
    escortCommitDistance: 20,
  ...
  hard: {
    ...
    turnRateRadians: 5.2,
    aimLeadSeconds: 0.04,
    aimErrorRadians: 0.15,
    aimJitterRefreshMs: [480, 940],
    aimFireToleranceScale: 0.96,
    fireChance: 0.48,
    secondaryChance: 0.28,
    fireDecisionMs: [400, 780],
    burstDurationMs: [180, 480],
    abilityCadenceMs: [1800, 3500],
    ultimateCadenceMs: [2600, 5200],
    preferredRangeScale: 1.06,
    aggression: 0.76,
    retreatHealthRatio: 0.37,
    routeDangerWeight: 0.86,
    blockedEdgeTtlMs: 2200,
    pathExpansionLimit: 42,
    memoryMs: 1900,
    minHealValue: 108,
    abilityScoreThreshold: 102,
    replanIntervalMs: 520,
    localProbeDistance: 1.7,
    focusFireWeight: 0.7,
    escortCommitDistance: 28,
    directRouteBias: 0.95,
  },
};
