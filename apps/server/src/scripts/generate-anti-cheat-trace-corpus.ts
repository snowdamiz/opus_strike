...
const legalTraces: Array<{ group: 'smoke' | 'full'; file: string; trace: AntiCheatMovementTrace }> = [
    ...
    trace: buildLegalTrace({
      ...
      steps: [
        { buttons: SPRINT_FORWARD, frames: 16 },
        {
          ...
          movementPatch: { isGrappling: true, grapplePoint: vec(8, 5, -8), isGrounded: false },
        },
        { buttons: SPRINT_FORWARD, frames: 16, flagCarrier: true, movementPatch: { isGrappling: false, grapplePoint: null } },
      ],
    }),
  },
  {
  ...
  },
  {
    ...
    trace: buildLegalTrace({
      id: 'legal-wallrun-glide-fall',
      heroId: 'hookshot',
      movementClass: 'wallrun_glide_fall',
      steps: [
        { buttons: SPRINT_FORWARD, frames: 8 },
        { buttons: SPRINT_FORWARD | MOVEMENT_BUTTON_MOVE_RIGHT, frames: 20, movementPatch: { isGrounded: false, isWallRunning: true, wallRunSide: 'right' } },
        { buttons: FORWARD, frames: 20, movementPatch: { isWallRunning: false, wallRunSide: null, isGliding: true } },
        { buttons: 0, frames: 20, movementPatch: { isGliding: false } },
      ],
    }),
  },
  {
