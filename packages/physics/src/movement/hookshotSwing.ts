...
export const HOOKSHOT_SWING_LOOK_STEER = 46;
export const HOOKSHOT_SWING_INPUT_STEER = 30;
export const HOOKSHOT_SWING_STRAFE_PUMP = 13;
export const HOOKSHOT_SWING_STRAFE_PUMP_MAX_SPEED = 46;
...
export const HOOKSHOT_SWING_MAX_SPEED = 72;
