...
assert.equal(getDistanceToBlazeAfterburnerTrail({ x: 4, y: 3, z: 0 }, trailStart, trailEnd), 1);
assert.equal(getDistanceToBlazeAfterburnerTrail({ x: 10, y: 2, z: 0 }, trailStart, trailEnd), 2);
