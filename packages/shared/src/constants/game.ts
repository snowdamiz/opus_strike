...
// Apex-style body shield: absorbs damage before health, breaks at 0, slowly
...
export const BATTLE_ROYAL_SOUL_COLLECT_DURATION_MS = 2_000;
export const BATTLE_ROYAL_SOUL_SUMMON_DURATION_MS = 2_000;
export const BATTLE_ROYAL_SOUL_INTERACTION_RADIUS = 2.4;
export const BATTLE_ROYAL_SUMMONING_CIRCLE_INTERACTION_RADIUS = 3.2;
export const BATTLE_ROYAL_SUMMONING_CIRCLE_RADIUS = 3;
export const BATTLE_ROYAL_SUMMONING_CIRCLE_COUNT = 4;
