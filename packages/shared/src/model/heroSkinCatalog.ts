...
export const HERO_SKIN_CATALOG = [
  ...
  {
    id: 'phantom.liberty-wraith',
    heroId: 'phantom',
    displayName: 'Liberty Wraith',
    subtitle: 'An Independence Day Phantom frame with midnight-blue void glass, red-white parade bars, and firework-bright gauntlet light.',
    rarity: 'unique',
    availability: 'unlockable',
    releaseState: 'live',
    modelDocumentId: 'phantom.liberty-wraith',
    unlockHint: 'Independence Day admin grant',
  },
  {
    id: 'hookshot.liberty-anchor',
    heroId: 'hookshot',
    displayName: 'Liberty Anchor',
    subtitle: 'A star-spangled Hookshot rig with navy anchor plating, bright stripe trim, and firework-lit hook prongs.',
    rarity: 'unique',
    availability: 'unlockable',
    releaseState: 'live',
    modelDocumentId: 'hookshot.liberty-anchor',
    unlockHint: 'Independence Day admin grant',
  },
  {
    id: 'blaze.liberty-flare',
    heroId: 'blaze',
    displayName: 'Liberty Flare',
    subtitle: 'A rocket-bright Blaze chassis with patriotic plume vents, white-hot star cores, and crimson launch rails.',
    rarity: 'unique',
    availability: 'unlockable',
    releaseState: 'live',
    modelDocumentId: 'blaze.liberty-flare',
    unlockHint: 'Independence Day admin grant',
  },
  {
    id: 'chronos.liberty-sentinel',
    heroId: 'chronos',
    displayName: 'Liberty Sentinel',
    subtitle: 'A ceremonial Chronos frame with blue chrono glass, red-white time bands, and firework-white orbit rings.',
    rarity: 'unique',
    availability: 'unlockable',
    releaseState: 'live',
    modelDocumentId: 'chronos.liberty-sentinel',
    unlockHint: 'Independence Day admin grant',
  },
  {
    id: 'phantom.golden',
